...
const images = [
  {
    original: `${Image1}`,
    thumbnail: `${Thumb1}`,
    thumbnailLabel: 'Exclusive High-Speed servers',
  },
  {
    original: `${Image1}`,
    thumbnail: `${Thumb2}`,
    thumbnailLabel: 'Unblock ALL Streaming services',
  },
  {
    original: `${Image1}`,
    thumbnail: `${Thumb3}`,
    thumbnailLabel: '24/7 Premium Customer Support',
  },
  {
    original: `${Image1}`,
    thumbnail: `${Thumb4}`,
    thumbnailLabel: 'Free version available',
  },
  {
    original: `${Image1}`,
    thumbnail: `${Thumb5}`,
    thumbnailLabel: 'Works in Android & iOS',
  },
  {
    original: `${Image1}`,
    thumbnail: `${Thumb6}`,
    thumbnailLabel: '100+ VPN Countries',
  },
];
...
FeatureSlider.defaultProps = {
  sectionHeader: {},
  sectionSubTitle: {
    content: 'WHAT MAKES US "THE BEST VPN UNBLOCKER"',
    as: 'span',
    display: 'block',
    textAlign: 'center',
    fontSize: '14px',
