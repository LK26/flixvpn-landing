...
const GlobalStyle = createGlobalStyle`
  ...
  section{
    ...
    button.modalCloseBtn {
      ...
      &.alt {
        background-color: ${themeGet('colors.primary', '#fe5722')} !important;
...
const AppWrapper = styled.div`
    ...
    .hamburgMenu__bar {
      ...
      > span {
        ...
        @media only screen and (max-width: 990px) {
          background-color: ${themeGet('colors.primary', '#fe5722')};
        }
      }
    }
  }
  .sticky-nav-active {
    .reusecore__navbar {
      ...
      .reusecore__button {
        .btn-icon {
          color: ${themeGet('colors.primary', '#fe5722')};
        }
      }
